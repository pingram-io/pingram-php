 ...
 *
 * @category Class
 * @description GET /account/invoices response.
 * @package  Pingram
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ListInvoicesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'invoices' => '\Pingram\Model\ListInvoicesResponseInvoicesInner[]',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Gets invoices
     *
     * @return \Pingram\Model\ListInvoicesResponseInvoicesInner[]
     */
     ...
     * Sets invoices
     *
     * @param \Pingram\Model\ListInvoicesResponseInvoicesInner[] $invoices invoices
     *
     * @return self
     */
     ...
     * Sets has_more
     *
     * @param bool $has_more True when more invoices exist; pass the last invoice `id` as `startingAfter`.
     *
     * @return self
     */
