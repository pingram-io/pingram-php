...
/**
 * ListPersonalAccessTokensResponseTokensInner Class Doc Comment
 *
 * @category Class
 * @description Public metadata returned by list/create (no tokenHash).
 * @package  Pingram
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ListPersonalAccessTokensResponseTokensInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListPersonalAccessTokensResponse_tokens_inner';
