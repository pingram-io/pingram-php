<?php
/**
 * BindNumberResponseAgentSpecToolsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * BindNumberResponseAgentSpecToolsInner Class Doc Comment
 *
 * @category Class
 * @package  Pingram
 * @author   OpenAPI Generator team
 ...
 */
class BindNumberResponseAgentSpecToolsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BindNumberResponse_agent_spec_tools_inner';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'parameters' => 'array<string,object>',
        'url' => 'string',
        'label' => 'string',
        'documents' => '\Pingram\Model\KnowledgeDocumentsInner[]'
    ];
    ...
    public const TYPE_DTMF = 'dtmf';
    public const TYPE_CUSTOM = 'custom';
    public const TYPE_MCP = 'mcp';
    public const TYPE_KNOWLEDGE = 'knowledge';
    public const TRANSFER_MODE_WARM = 'warm';
    public const TRANSFER_MODE_COLD = 'cold';
    ...
    {
        return [
            self::TRANSFER_MODE_WARM,
            self::TRANSFER_MODE_COLD,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('briefing', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transfer_mode'] === null) {
            $invalidProperties[] = "'transfer_mode' can't be null";
        }
    ...
    {
        if (is_null($briefing)) {
            throw new \InvalidArgumentException('non-nullable briefing cannot be null');
        }
     ...
     * Sets parameters
     *
     * @param array<string,object> $parameters parameters
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \Pingram\Model\KnowledgeDocumentsInner[]
     */
     ...
     * Sets documents
     *
     * @param \Pingram\Model\KnowledgeDocumentsInner[] $documents documents
     *
     * @return self
     */
