<?php
/**
 * DeleteEmailSuppressionsResponse
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * DeleteEmailSuppressionsResponse Class Doc Comment
 *
 * @category Class
 * @package  Pingram
 * @author   OpenAPI Generator team
 ...
 */
class DeleteEmailSuppressionsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteEmailSuppressionsResponse';
    ...
    */
     ...
     * Sets removed
     *
     * @param float $removed Number of users whose email suppression was removed.
     *
     * @return self
     */
     ...
     * Sets skipped
     *
     * @param float $skipped Number of suppressed users that did not match the requested reason.
     *
     * @return self
     */
