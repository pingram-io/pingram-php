 ...
 *
 * @category Class
 * @description Request body for POST /keys endpoint Creates a new API key for an environment
 * @package  Pingram
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreateKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets key_type
     *
     * @param string $key_type Type of key to create - secret for server-to-server, public for client-side
     *
     * @return self
     */
     ...
     * Sets environment_id
     *
     * @param string|null $environment_id Optional environment ID to scope the key to a specific environment
     *
     * @return self
     */
