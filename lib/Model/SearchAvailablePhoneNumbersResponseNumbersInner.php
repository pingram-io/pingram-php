...
/**
 * SearchAvailablePhoneNumbersResponseNumbersInner Class Doc Comment
 *
 * @category Class
 * @description One available number returned from search
 * @package  Pingram
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SearchAvailablePhoneNumbersResponseNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchAvailablePhoneNumbersResponse_numbers_inner';
    ...
    */
     ...
     *
     * @param string|null $phone_number_type e.g. local, toll_free
     *
     * @return self
     */
     ...
     * Sets features
     *
     * @param string[]|null $features e.g. sms, voice, mms
     *
     * @return self
     */
