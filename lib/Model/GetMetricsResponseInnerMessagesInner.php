...
/**
 * GetMetricsResponseInnerMessagesInner Class Doc Comment
 *
 * @category Class
 ...
 */
class GetMetricsResponseInnerMessagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetMetricsResponse_inner_Messages_inner';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code <p>The error code or status code associated with the message.</p>
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value <p>The message text.</p>
     *
     * @return self
     */
