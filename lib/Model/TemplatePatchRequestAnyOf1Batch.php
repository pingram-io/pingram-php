...
/**
 * TemplatePatchRequestAnyOf1Batch Class Doc Comment
 *
 * @category Class
 * @description In-app batch delivery: title, redirect URL, and image URL shown when the notification is delivered in batch.
 * @package  Pingram
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TemplatePatchRequestAnyOf1Batch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplatePatchRequest_anyOf_1_batch';
