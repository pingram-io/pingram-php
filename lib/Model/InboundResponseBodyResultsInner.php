<?php
/**
 * InboundResponseBodyResultsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InboundResponseBodyResultsInner Class Doc Comment
 *
 * @category Class
 * @package  Pingram
 * @author   OpenAPI Generator team
 ...
 */
class InboundResponseBodyResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboundResponseBody_results_inner';
     ...
     * @return string[]
     */
    public function getAutoReplyAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAutoReplyAllowableValues();
        if (!is_null($this->container['auto_reply']) && !in_array($this->container['auto_reply'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'auto_reply', must be one of '%s'",
                $this->container['auto_reply'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets auto_reply
     *
     * @param string $auto_reply auto_reply
     *
     * @return self
     */
    public function setAutoReply($auto_reply)
    {
        ...
        $allowedValues = $this->getAutoReplyAllowableValues();
        if (!in_array($auto_reply, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'auto_reply', must be one of '%s'",
                    $auto_reply,
