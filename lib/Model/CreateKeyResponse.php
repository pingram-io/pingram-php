 ...
 *
 * @category Class
 * @description Response body for POST /keys endpoint Returns the newly created API key (only time the full key is returned)
 * @package  Pingram
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreateKeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets key
     *
     * @param string $key The full API key string - ONLY returned on creation, never shown again
     *
     * @return self
     */
     ...
     * Sets key_type
     *
     * @param string $key_type Type of API key that was created
     *
     * @return self
     */
