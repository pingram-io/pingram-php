...
/**
 * SupabaseStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  Pingram
 * @author   OpenAPI Generator team
 ...
 */
class SupabaseStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupabaseStatusResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('configured_at', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets configured_at
     *
     * @param string|null $configured_at configured_at
     *
     * @return self
     */
    public function setConfiguredAt($configured_at)
    {
        if (is_null($configured_at)) {
            throw new \InvalidArgumentException('non-nullable configured_at cannot be null');
        }
