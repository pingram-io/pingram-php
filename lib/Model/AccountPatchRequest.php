...
/**
 * AccountPatchRequest Class Doc Comment
 *
 * @category Class
 * @description PATCH /account request: billing preferences.
 * @package  Pingram
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AccountPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountPatchRequest';
    ...
    */
     ...
     * Sets auto_upgrade
     *
     * @param bool|null $auto_upgrade When true, automatically move up one budget tier at 90% of the monthly budget.
     *
     * @return self
     */
