 ...
 */
class SenderPostBodyWebPush implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SenderPostBody_web_push';
