 ...
 */
class BeeTokenV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'beeTokenV2';
    ...
    */
    ...
    {
        if (is_null($v2)) {
            throw new \InvalidArgumentException('non-nullable v2 cannot be null');
        }
