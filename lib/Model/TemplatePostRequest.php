...
/**
 * TemplatePostRequest Class Doc Comment
 *
 * @category Class
 * @description Request body for creating a template. Include templateId (required) plus any channel-specific fields for the channel in the path. Which fields apply depends on the channel (EMAIL, INAPP_WEB, SMS, PUSH, etc.).
 * @package  Pingram
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TemplatePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplatePostRequest';
    ...
    */
     ...
     * Sets template_id
     *
     * @param string $template_id Unique ID for this template within the notification and channel. Required.
     *
     * @return self
     */
