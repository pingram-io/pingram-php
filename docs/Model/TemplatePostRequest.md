...
------------ | ------------- | ------------- | -------------
**template_id** | **string** | Unique ID for this template within the notification and channel. Required. |
...
**instant** | [**\Pingram\Model\TemplatePostRequestInstant**](TemplatePostRequestInstant.md) |  | [optional]
**batch** | [**\Pingram\Model\TemplatePostRequestBatch**](TemplatePostRequestBatch.md) |  | [optional]
